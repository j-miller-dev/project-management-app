...
const TaskColumn = ({
    ...
    return (
        <div
            ...
            className={`sl:pl-4 rounded-lg py-2 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neutral-950" : ""}`}
        >
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-s3-images123.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://pm-s3-images123.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-s3-images123.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
